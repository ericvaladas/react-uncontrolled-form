...
I decided to build something that I think is easy to understand, quick to implement, flexible, doesn't do more than it needs to, and I wanted it to have an API that felt obvious and familiar.
